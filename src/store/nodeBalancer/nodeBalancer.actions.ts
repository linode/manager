...
export interface BalancerParams { nodeBalancerId: number };

type Entity = Linode.NodeBalancer;

export const getAllNodeBalancersActions = actionCreator.async<void, Linode.NodeBalancer[], Linode.ApiFieldError[]>(`get-all`);

export type CreateNodeBalancerParams =CreateNodeBalancerPayload;

export const createNodeBalancersActions = actionCreator.async<CreateNodeBalancerParams, Entity, Linode.ApiFieldError[]>(`create`);
...
export const updateNodeBalancersActions = actionCreator.async<UpdateNodeBalancerParams, Entity, Linode.ApiFieldError[]>(`update`);
...
export const getNodeBalancerWithConfigsActions = actionCreator.async<GetNodeBalancerWithConfigsParams, Linode.NodeBalancer, Linode.ApiFieldError>(`get`);
