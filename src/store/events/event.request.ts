 ...
 */
export const getEvents: ThunkActionCreator<Promise<Linode.Event[]>> = () => (dispatch, getState) => {
 ...
 */
export const markAllSeen:ThunkActionCreator<Promise<any>> = () => (dispatch, getState) => {
