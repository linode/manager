...
export class EditConfigPage extends Component {
  ...
  render() {
    ...
    const { enableDistroHelper, enableNetworkHelper, enableModulesdepHelper, disableUpdatedb,
    } = this.state.helpers;

    console.log(enableDistroHelper, enableNetworkHelper, disableUpdatedb, this.state);
