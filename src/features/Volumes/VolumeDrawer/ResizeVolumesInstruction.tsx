  ...
  return (
    <React.Fragment>
      ...
      <div className={classes.copySection}>
        ...
        <CopyableTextField className={classes.copyField} value={`umount /dev/disk/by-id/scsi-0Linode_Volume_${volumeLabel}`} data-qa-umount/>
      </div>
      ...
      <div className={classes.copySection}>
        ...
        <CopyableTextField className={classes.copyField} value={`e2fsck -f /dev/disk/by-id/scsi-0Linode_Volume_${volumeLabel}`} data-qa-check-filesystem/>
        <CopyableTextField className={classes.copyField} value={`resize2fs /dev/disk/by-id/scsi-0Linode_Volume_${volumeLabel}`} data-qa-resize-filesystem/>
      </div>

      <div className={classes.copySection}>
        <Typography variant="body1">Now mount it back onto the filesystem:</Typography>
        <CopyableTextField className={classes.copyField} value={`mount /dev/disk/by-id/scsi-0Linode_Volume_${volumeLabel} /mnt/${volumeLabel}`} data-qa-mount/>
      </div>
      <ActionsPanel>
