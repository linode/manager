...
const getClampedPrice = (newSize: number, currentSize: number) => newSize >= currentSize
...
const PricePanel: React.StatelessComponent<CombinedProps> = ({ currentSize, value, classes }) => {
