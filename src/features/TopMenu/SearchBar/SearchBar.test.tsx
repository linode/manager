import { getMatchingTags, filterMatched } from './SearchBar';
...
describe("filterMatched method", () => {
  it("should find return true if either tags or label match", () => {
    expect(filterMatched('tags', 'TAGS', ['tag1', 'tag2', 'tag3'])).toBeTruthy();
    expect(filterMatched('tags', 'TAG', ['tags1', 'tag2', 'tag3'])).toBeTruthy();
    expect(filterMatched('tags', 'TAGS', ['tags1', 'tag2', 'tag3'])).toBeTruthy();
  });
