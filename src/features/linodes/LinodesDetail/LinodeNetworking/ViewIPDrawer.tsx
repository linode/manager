      ...
      {props.ip &&
        <React.Fragment>
          <div className={classes.section} data-qa-ip-address-heading>
            <Typography role="header" variant="h3">Address</Typography>
          ...
          <div className={classes.section} data-qa-gateway-heading>
            <Typography role="header" variant="h3">Gateway</Typography>
          ...
          <div className={classes.section} data-qa-subnet-heading>
            <Typography role="header" variant="h3">Subnet Mask</Typography>
          ...
          <div className={classes.section} data-qa-type-heading>
            <Typography role="header" variant="h3">Type</Typography>
          ...
          <div className={classes.section} data-qa-public-heading>
            <Typography role="header" variant="h3">Public</Typography>
          ...
          {props.ip.rdns &&
            <div className={classes.section} data-qa-rdns-heading>
              <Typography role="header" variant="h3">RDNS</Typography>
          ...
          >
            <Typography role="header" variant="h3">Region</Typography>
