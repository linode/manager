...
class MongoCredStore extends CredStore {
    ...
    generateCreds(config, userCount) {
        ...
        return this._connect().then((mongoClient) => {
            ...
            const collection = mongoClient.db(this.dbName).collection(this.collectionName);
    ...
    getAllCreds() {
        ...
        return this._connect().then((mongoClient) => {
            ...
            return mongo.close().then((r) => { return credsCollection; });
        });
    }
...
if (process.argv[2] == "test-mongo") {
    ...
    mongoCredStore.generateCreds(mockTestConfig, 2)
    .then((r) => {
