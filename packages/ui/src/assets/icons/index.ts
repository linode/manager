...
export { default as ErrorToastIcon } from './error-toast.svg';
export { default as InfoIcon } from './info.svg';
export { default as InfoToastIcon } from './info-toast.svg';
...
export { default as SuccessToastIcon } from './info-toast.svg';
