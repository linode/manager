...
const DISK_ENCRYPTION_GENERAL_DESCRIPTION = (
  <>
...
const DISK_ENCRYPTION_DISTRIBUTED_DESCRIPTION =
...
const DISK_ENCRYPTION_UPDATE_PROTECT_CLUSTERS_COPY = (
  <>
...
const DISK_ENCRYPTION_BACKUPS_CAVEAT_COPY =
...
const ENCRYPT_DISK_REBUILD_DISTRIBUTED_COPY =
...
const BLOCK_STORAGE_ENCRYPTION_UNAVAILABLE_IN_LINODE_REGION_COPY =
...
const BLOCK_STORAGE_ENCRYPTION_SETTING_IMMUTABLE_COPY =
  'The encryption setting cannot be modified after a volume has been created.';

const BLOCK_STORAGE_CLONING_INHERITANCE_CAVEAT =
