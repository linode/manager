...
const nodeWarning = `We recommend a minimum of 3 nodes in each Node Pool to avoid downtime during upgrades and maintenance.`;
const nodesDeletionWarning = `All nodes will be deleted and new nodes will be created to replace them.`;
const localStorageWarning = `Any local storage (such as \u{2019}hostPath\u{2019} volumes) will be erased.`;
...
const getTotalClusterMemoryCPUAndStorage = (
...
const getDescriptionForCluster = (
 ...
 */
const useLkeStandardOrEnterpriseVersions = (
