...
const useNodeBalancerStatsQuery = (id: number) => {
...
const useNodeBalancerQuery = (id: number, enabled = true) =>
...
// Please don't use
const useAllNodeBalancersQuery = (enabled = true) =>
  useQuery<NodeBalancer[], APIError[]>({
...
const nodebalancerEventHandler = ({
  event,
  invalidateQueries,
}: EventHandlerData) => {
