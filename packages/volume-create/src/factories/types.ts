...
const typeFactory = Factory.Sync.makeFactory<LinodeType>({
...
const planSelectionTypeFactory = Factory.Sync.makeFactory<PlanWithAvailability>(
  {
...
const extendedTypeFactory = Factory.Sync.makeFactory<
...
const distributedNetworkTransferPriceTypeFactory = Factory.Sync.makeFactory<PriceType>(
  {
...
const networkTransferPriceTypeFactory = Factory.Sync.makeFactory<PriceType>(
  {
    id: 'network_transfer',
