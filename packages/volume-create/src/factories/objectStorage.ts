...
const objectStorageBucketFactory = Factory.Sync.makeFactory<ObjectStorageBucket>(
  {
    cluster: 'us-east-1',
...
const createObjectStorageBucketFactoryLegacy = Factory.Sync.makeFactory<CreateObjectStorageBucketPayload>(
  {
    acl: 'private',
    cluster: 'us-east-1',
    cors_enabled: true,
...
const createObjectStorageBucketFactoryGen1 = Factory.Sync.makeFactory<CreateObjectStorageBucketPayload>(
  {
    acl: 'private',
    cors_enabled: true,
    label: Factory.each((i) => `obj-bucket-${i}`),
...
const createObjectStorageBucketFactoryGen2 = Factory.Sync.makeFactory<CreateObjectStorageBucketPayload>(
  {
    acl: 'private',
    cors_enabled: false,
    endpoint_type: 'E1',
...
const objectStorageObjectFactory = Factory.Sync.makeFactory<ObjectStorageObject>(
  {
...
const objectStorageKeyFactoryGen2 = Factory.Sync.makeFactory<ObjectStorageKey>(
  {
    access_key: '4LRW3T5FX5Z55LB3LYQ8',
    bucket_access: null,
    id: Factory.each((id) => id),
