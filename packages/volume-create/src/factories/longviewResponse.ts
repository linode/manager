...
const longviewResponseFactory = Factory.Sync.makeFactory<LongviewResponse>(
  {
...
const longviewLatestStatsFactory = Factory.Sync.makeFactory<
  Partial<AllData>
>({
  ...longviewResponseData(),
});

const longviewPackageFactory = Factory.Sync.makeFactory<LongviewPackage>(
  {
