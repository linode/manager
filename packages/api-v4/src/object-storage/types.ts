...
export interface ObjectStorageBucketRequestPayload {
  label: string;
  region?: string; // TODO: OBJ-MULTI-CLUSTER - This field will become required, and the 'cluster' field will be deprecated once the feature is fully rolled out in production as part of the process of cleaning up the 'objMultiCluster' feature flag.
  cluster?: string;
