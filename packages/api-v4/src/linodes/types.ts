...
export interface LinodeWithCloudPulseAlerts extends Omit<Linode, 'alerts'> {
  alerts: CloudPulseAlertsPayload;
}

export interface LinodeWithLegacyAlerts extends Omit<Linode, 'alerts'> {
  alerts: LinodeAlerts;
}
