!(function(e, t) {
  ...
  return (function(e) {
    ...
    function(e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = t.CancellableRequest = t.mockAPIError = t.requestGenerator = t.setXFilter = t.setData = t.setHeaders = t.setParams = t.setMethod = t.setURL = t.setToken = t.baseRequest = void 0);
      var r,
      ...
      t.baseRequest = c;
      t.setToken = e =>
        c.interceptors.request.use(t =>
          i({}, t, {
            headers: i({}, t.headers, { Authorization: `Bearer ${e}` })
          })
        );
      const f = {
      ...
      t.setHeaders = (e = {}) =>
        (0, u.when)(
          () => l(e),
          (0, u.over)(f.headers, (0, u.mergeDeepLeft)(e))
        );
      t.setData = (e, t, n) => {
    ...
    function(e, t, n) {
      ...
      const a = (0, r.object)({
        ...
        authentication_type: (0, r.string)().oneOf(['password', 'github'])
      });
    ...
    function(e, t, n) {
      ...
      const a = (0, r.object)().shape({
        ...
        k8s_version: (0, r.string)().required(
    ...
    function(e, t, n) {
      ...
      function Ne() {
        ...
        var e = Array.prototype.slice.call(arguments),
          t = e.pop();
        return We(We.apply(this, V(Re, e)), t);
      }
      function Ge(e, t) {
        return function() {
          var n = this;
      ...
      function Be() {
        ...
        return Ve.apply(this, ze(arguments));
      }
    ...
    function(e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 });
      var r = { baseRequest: !0, setToken: !0 };
    ...
    function(e, t, n) {
      ...
      const u = (0, r.object)().shape({
          ...
          master_ips: (0, r.array)().of((0, r.string)()),
          axfr_ips: (0, r.array)()
            .of((0, r.string)())
    ...
    function(e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.getKubernetesClusterEndpoints = t.getKubernetesVersion = t.getKubernetesVersions = t.getKubeConfig = t.deleteKubernetesCluster = t.updateKubernetesCluster = t.createKubernetesCluster = t.getKubernetesCluster = t.getKubernetesClusters = void 0);
      var r = n(0),
        o = (function(e) {
          if (e && e.__esModule) return e;
          if (null === e || ('object' != typeof e && 'function' != typeof e))
      ...
      t.getKubernetesClusters = (e, t) =>
        (0, o.default)(
          ...
          (0, o.setParams)(e),
          (0, o.setXFilter)(t),
          (0, o.setURL)(`${r.API_ROOT}/lke/clusters`)
        ).then(e => e.data);
      t.getKubernetesCluster = e =>
        (0, o.default)(
          (0, o.setMethod)('GET'),
          (0, o.setURL)(`${r.API_ROOT}/lke/clusters/${e}`)
        ).then(e => e.data);
      ...
      t.getKubeConfig = e =>
        (0, o.default)(
          (0, o.setMethod)('GET'),
          (0, o.setURL)(`${r.API_ROOT}/lke/clusters/${e}/kubeconfig`)
        ).then(e => e.data);
      t.getKubernetesVersions = () =>
        (0, o.default)(
          (0, o.setMethod)('GET'),
          (0, o.setURL)(`${r.API_ROOT}/lke/versions`)
        ).then(e => e.data);
      t.getKubernetesVersion = e =>
        (0, o.default)(
          (0, o.setMethod)('GET'),
          (0, o.setURL)(`${r.API_ROOT}/lke/versions/${e}`)
        ).then(e => e.data);
      t.getKubernetesClusterEndpoints = e =>
        (0, o.default)(
          (0, o.setMethod)('GET'),
          (0, o.setURL)(`${r.API_ROOT}/lke/clusters/${e}/api-endpoints`)
        ).then(e => e.data);
    },
    function(e, t, n) {
      'use strict';
      ...
      t.getNodePools = (e, t, n) =>
        (0, o.default)(
          ...
          (0, o.setParams)(t),
          (0, o.setXFilter)(n),
          (0, o.setURL)(`${r.API_ROOT}/lke/clusters/${e}/pools`)
        ).then(e => e.data);
      t.getNodePool = (e, t) =>
        (0, o.default)(
          (0, o.setMethod)('GET'),
          (0, o.setURL)(`${r.API_ROOT}/lke/clusters/${e}/pools/${t}`)
        ).then(e => e.data);
    ...
    function(e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.getObjectList = t.deleteBucket = t.createBucket = t.getBucketsInCluster = t.getBuckets = void 0);
      var r = n(0),
        o = (function(e) {
          if (e && e.__esModule) return e;
          if (null === e || ('object' != typeof e && 'function' != typeof e))
      ...
      t.getBucketsInCluster = (e, t, n) =>
        (0, o.default)(
          (0, o.setMethod)('GET'),
          (0, o.setParams)(t),
          (0, o.setXFilter)(n),
          (0, o.setURL)(`${r.API_ROOT}/object-storage/buckets/${e}`)
        ).then(e => e.data);
      t.createBucket = e =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/object-storage/buckets`),
    ...
    function(e, t, n) {
      ...
      t.getTickets = (e, t) =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/support/tickets`),
          (0, o.setMethod)('GET'),
          (0, o.setParams)(e),
          (0, o.setXFilter)(t)
        );
      t.getTicket = e =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/support/tickets/${e}`),
          (0, o.setMethod)('GET')
        ).then(e => e.data);
      t.getTicketReplies = (e, t, n) =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/support/tickets/${e}/replies`),
          (0, o.setMethod)('GET'),
          (0, o.setParams)(t),
          (0, o.setXFilter)(n)
        ).then(e => e.data);
      t.createSupportTicket = e =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/support/tickets`),
          (0, o.setMethod)('POST'),
          (0, o.setData)(e, u.createSupportTicketSchema)
        ).then(e => e.data);
      t.closeSupportTicket = e =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/support/tickets/${e}/close`),
          (0, o.setMethod)('POST')
        ).then(e => e.data);
      t.createReply = e =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/support/tickets/${e.ticket_id}/replies`),
          (0, o.setMethod)('POST'),
          (0, o.setData)(e, u.createReplySchema)
        ).then(e => e.data);
      t.uploadAttachment = (e, t) =>
        (0, o.default)(
          (0, o.setURL)(`${r.API_ROOT}/support/tickets/${e}/attachments`),
          (0, o.setMethod)('POST'),
          (0, o.setData)(t)
        ).then(e => e.data);
    },
