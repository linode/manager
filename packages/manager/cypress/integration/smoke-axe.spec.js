describe('smoke - axe',()=>{
    const routes = {
        linodes:[
            // {route:'/linodes',
            {url:'/linodes/create?type=Distributions',el:'Choose a Distribution'},
            {url:'/linodes/create?type=One-Click', el:'Select App'},
            {url:'/linodes/create?type=My%20Images&subtype=Images',el:"Choose an Image"},
            {url:'/linodes/create?type=My%20Images&subtype=Backups',el:'Select Backup'},
            {url:'/linodes/create?type=My%20Images&subtype=Clone%20Linode',el:'Select Linode to Clone From'},
