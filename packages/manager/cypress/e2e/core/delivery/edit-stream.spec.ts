...
describe('Edit Stream', () => {
  ...
  describe('given Audit Logs Stream Type', () => {
    it('edits stream label and destination and saves', () => {
      ...
      // Edit Stream button should be disabled after changing destination
      ui.button.findByTitle('Edit Stream').should('be.disabled');
      ...
      // Edit Stream button should remain disabled after failed test
      ui.button.findByTitle('Edit Stream').should('be.disabled');
      ...
      // Edit Stream button should now be enabled
      ui.button.findByTitle('Edit Stream').should('be.enabled');

      // Submit the stream edit form - failure in creating destination
      mockCreateDestination({}, 400);
      ui.button.findByTitle('Edit Stream').should('be.enabled').click();
      ...
      ui.button.findByTitle('Edit Stream').click();
