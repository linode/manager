...
import {
  vpcAssignLinodeNotice,
  vpcUnassignLinodeNotice,
...
describe('VPC assign/unassign flows', () => {
  ...
  it('can assign Linode(s) to a VPC', () => {
    ...
    ui.drawer
      ...
      .within(() => {
        ...
        cy.findByText(vpcAssignLinodeNotice).should('be.visible');
  ...
  it('can unassign Linode(s) from a VPC', () => {
    ...
    ui.drawer
      ...
      .within(() => {
        // confirm that the user is warned that a reboot is required
        cy.findByText(vpcUnassignLinodeNotice).should('be.visible');
        ...
        cy.findByText(vpcUnassignLinodeNotice).click();
