...
import { clearStorageAndRedirectToLogout } from './layouts/OAuth';
import { authentication, getEnvLocalStorageOverrides } from './utilities/storage';
...
export const setupInterceptors = (store: ApplicationStore) => {
  baseRequest.interceptors.request.use((config) => {
    ...
    const token = ACCESS_TOKEN || authentication.token.get();
