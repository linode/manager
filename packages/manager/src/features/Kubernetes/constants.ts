...
export const CREATE_CLUSTER_ENTERPRISE_TIER_ACL_COPY_BASE =
...
export const CREATE_CLUSTER_ENTERPRISE_TIER_ACL_COPY_REQUIRED_IPs = `${CREATE_CLUSTER_ENTERPRISE_TIER_ACL_COPY_BASE} Add at least one IP address or CIDR range.`;
