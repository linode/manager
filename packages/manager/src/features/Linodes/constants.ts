...
export const METRICS_BETA_AND_NEW_MODE_BUTTON_TEXT = 'Switch to legacy Metrics';
...
export const ALERTS_NEW_MODE_BANNER_TEXT =
...
export const ALERTS_BETA_AND_NEW_MODE_BUTTON_TEXT = 'Switch to legacy Alerts';
