...
export const PlanContainer = ({
  ...
  // If the user has selected a premium eligible plan, but changes the region to a non eligible premium region,
  // we need to clear the selection to to keep our error handling consistent on submit.
  React.useEffect(() => {
    if (disabled) {
      onSelect('');
    }
