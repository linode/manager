...
import { LinodeInterfacesHistoryTableContent } from './LinodeInterfacesHistoryTableContent';
...
export const LinodeInterfacesHistoryTable = (props: Props) => {
  ...
  return (
    <>
      <Table>
        ...
        <TableBody>
          <LinodeInterfacesHistoryTableContent
