...
export const gettingStartedGuides: ResourcesLinks['links'] = [
  ...
  },
  {
    ...
    to: 'https://www.linode.com/docs/guides/how-to-build-your-infrastructure-using-terraform-and-linode/#install-terraform',
  },
  {
  ...
  },
  {
    ...
    to: 'https://www.linode.com/docs/guides/how-to-use-terraform-with-linode-object-storage/',
  },
  {
    text: 'Use Terraform to Provision Infrastructure on Linode',
    to: 'https://www.linode.com/docs/guides/how-to-build-your-infrastructure-using-terraform-and-linode/',
  },
  {
    text: 'Import Existing Infrastructure to Terraform',
    to: 'https://www.linode.com/docs/guides/import-existing-infrastructure-to-terraform/',
  },
];
