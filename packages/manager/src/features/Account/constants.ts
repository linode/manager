...
// Delegate User Messaging
export const DELEGATE_USER_RESTRICTED_TOOLTIP_TEXT =
  'You can\u{2019}t perform this action on child accounts.';
export const DELEGATE_USER_CLOSE_ACCOUNT_TOOLTIP_TEXT = `Contact ${CUSTOMER_SUPPORT} to close this account.`;
