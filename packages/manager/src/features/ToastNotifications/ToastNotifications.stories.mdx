...
<Meta title="UI Elements/Notifications/Toasts" />
...
<Canvas>
  <Story 
    ...
    argTypes={{
      anchorOrigin: {
        description: 'Determine where the toast initially appears vertically and horizontally.',
      },
      maxSnack: {
        description: 'Set the maximum number of toasts that can appear simultaneously.',
      },
      hideIconVariant: {
        description: 'Determine whether variant icons appear to the left of the text in the toast.',
      }
    }}
  >
    {Template.bind({})}
