...
export const SelectStackScriptsSection: React.FC<React.PropsWithChildren<CombinedProps>> = (props) => {
...
export default SelectStackScriptsSection as React.FC<React.PropsWithChildren<Props>>;
