  ...
  return (
    <Box sx={{ width: '100%', background: 'white' }}>
      ...
      <Box sx={{ p: 3 }}>
        ...
        {/* SECTION 7/8/9: 66%/17%/17% width, 3 columns */}
        ...
        {/* SECTION 10/11/12: 3 columns, equal width */}
        <Grid container sx={{ mb: 4 }}>
          <Grid size={4} sx={{ pr: 2 }}>
            <SectionHeader>33%/33%/33% width - 3 columns</SectionHeader>
        ...
        {/* SECTION 13/14/15/16: 3 columns with stacked sections in the middle column */}
        <Grid container sx={{ mb: 4 }}>
          <Grid size={4} sx={{ pr: 2 }}>
            <SectionHeader>
              33%/33%/33% width - 3 columns + several sections in 2nd column
            </SectionHeader>
