...
<Canvas>
  <Story name="Primary">
    ...
    <Button buttonType="primary" compactX data-qa-button="primary">
      compactX Primary
    </Button>
...
<Canvas>
  <Story name="Secondary">
    ...
    <Button
      ...
      style={{ marginTop: 7, maxHeight: 20 }}
    >
      CompactY Secondary
    </Button>
...
<Canvas>
  <Story name="Outlined">
    ...
    <Button buttonType="outlined" compactX data-qa-button="outlined">
      compactX Outlined
    </Button>
...
<Canvas>
  <Story
    ...
    argTypes={{
      ...
      compactX: {
        description:
          'Removes the left and right spacing of the text for  buttons.',
        table: {
