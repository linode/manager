...
Beta chips label features that are not yet part of Cloud Manager's core supported functionality. Beta features should display text communicating the [Early Adopter SLA](https://www.linode.com/legal-eatp/). When a feature is in beta, beta chips may label the feature in the primary nav, breadcrumbs, banners, tabs, and/or plain text.
