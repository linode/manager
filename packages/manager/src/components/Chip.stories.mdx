...
**Example:** A 'beta' chip may appear in the [primary navigation](https://github.com/linode/manager/pull/8104), breadcrumbs, [banners](/src/components/DismissibleBanner/DismissibleBanner.stories.mdx), tabs, and/or plain text to designate beta functionality.
