...
**Example:** A 'beta' chip may appear in the [primary navigation](https://github.com/linode/manager/pull/8104), breadcrumbs, [banners](/docs/components-notifications-dismissible-banners--beta-banners), tabs, and/or plain text to designate beta functionality.

**Visual style:** variant styling has bold, capitalized text; reduced height, letter spacing, and font size; solid color background: MUI default color for light mode and MUI primary color for dark mode.
...
<Canvas>
  <Story
    ...
    argTypes={{
      ...
      variant: {
        description: 'Variant of the Chip `"default" | "outlined" | "beta"`',
        options: ['default', 'outlined', 'beta'],
        control: { type: 'radio' },
        table: {
          defaultValue: {
            summary: 'default',
