...
**Example:** A 'beta' chip may appear in the side menu navigation, breadcrumbs, banners, tabs, and/or plain text to designate beta functionality.
...
export const SideMenuBetaExample = () => {
  return (
    <>
       <PrimaryNav /> {/*TODO*/}
    </>
