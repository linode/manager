...
import { BRAND_UPDATE } from 'src/constants';
      ...
      <Grid item>
        <div
          className={classNames({
            [classes.logoItem]: !BRAND_UPDATE,
            [classes.logoItemAkamai]: BRAND_UPDATE && !isCollapsed,
            [classes.logoItemAkamaiWave]: BRAND_UPDATE && isCollapsed,
          })}
        >
          {isCollapsed && (
