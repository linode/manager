...
export const DeletionTemplate = (args, context) => (
  <div id="delete-dialog-story">
    <DeletionDialog
...
export const ConfirmationTemplate = (args, context) => (
  <div id="confirm-dialog-story">
    <ConfirmationDialog
      style={{ position: 'unset' }}
      disableEnforceFocus
      disableAutoFocus
      disablePortal
      disableScrollLock
      container={() => document.getElementById('confirm-modal-story')}
      {...args}
    >
      {args.children}
    </ConfirmationDialog>
...
export const NormalTemplate = (args, context) => (
  <div id="dialog-story">
    <Dialog
      style={{ position: 'unset' }}
      disableEnforceFocus
...
> ℹ️️ Clicking off of the modal will not close it.
