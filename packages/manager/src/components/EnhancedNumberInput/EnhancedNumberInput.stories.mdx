...
<Canvas>
  <Story
    ...
    argTypes={{
      value: {
        description: "Allows you to control the numeric value of the input from outside the component",
      ...
      max: {
        description: "The max number allowed in the input. The +/- buttons will disable accordingly",
      ...
      min: {
        description: "The min number allowed in the input. The +/- buttons will disable accordingly",
        type: { summary: 'number', name: 'number' },
        table: {
          defaultValue: {
            summary: '0',
      ...
      inputLabel: {
        description: "The label of the input. This prop does not cause any visual UI changes",
