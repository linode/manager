  ...
  <Story
    ...
    argTypes={{
      ...
      setErrors: {
        ...
        type: { summary: 'React.Dispatch<React.SetStateAction<APIError[] | undefined>>', required: true },
        control: { type: null },
      },
      setCancelFn: {
        description: "Allows you to set a cancel upload function in the parent component",
        type: { summary: 'React.Dispatch<React.SetStateAction<(() => void) | null>>', required: true },
        control: { type: null },
      },
      onSuccess: {
