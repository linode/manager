...
- Beta: Informs users of a feature in beta and includes the [Early Adopter SLA](https://www.linode.com/legal-eatp/).
...
export const BetaBannerTemplate = () => {
    return (
      <DismissibleBanner productInformationIndicator>
        <Typography>
...
Beta banners, along with [beta chips](/src/components/Chips.stories.mdx), provide notice to users about beta features.

<Canvas>
  <Story name="Beta Banners">
    {BetaBannerTemplate.bind({})}
  </Story>
</Canvas>
