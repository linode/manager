...
describe('Checkbox Component Suite', () => {
  ...
  it('should check on click', () => {
    ...
    expect(updatedCheckboxValues.length)
      .withContext(`Incorrect amount of updated checkboxes`)
      .toBe(initialChecked.length + enabledCheckboxes.length);
  });
  ...
  it('should uncheck on click', () => {
    ...
    expect(updatedCheckboxValues)
      .withContext(`Incorrect checkbox value`)
      .toEqual([]);
  });
  ...
  it('should not update values of disabled checked boxes', () => {
    ...
    expect(afterClick.length)
      .withContext(`Incorrect value for disabled checkbox`)
      .toBe(checkedDisabledBoxes.length);
  });
