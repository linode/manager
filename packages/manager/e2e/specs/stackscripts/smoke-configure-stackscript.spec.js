...
// TODO this smoke test needs a major overhaul as the page is working
// very differently than before and selectors have also changed
xdescribe('StackScript - Create Suite', () => {
  const stackConfig = {
  ...
  it('should fail to create the stackscript', () => {
    ...
    browser.waitUntil(() => {
      expect(ConfigureStackScripts.script.$('p').getText()).toNotBe(null);
    });
