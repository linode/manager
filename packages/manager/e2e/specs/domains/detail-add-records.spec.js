...
describe('Domains - Detail - Add Records Suite', () => {
  ...
  let domainEmail = `fake@gmail.com`;
  ...
  const checkSoaTableValues = (
    ...
    const primaryDomainElement = DomainDetail.domainTableCellValue(
      'SOA Record',
      'Primary Domain',
      0
    );
    const emailElement = DomainDetail.domainTableCellValue(
      'SOA Record',
      'Email',
      0
    );
    const ttlElement = DomainDetail.domainTableCellValue(
      'SOA Record',
      'Default TTL',
      0
    );
    const refreshRateElement = DomainDetail.domainTableCellValue(
      'SOA Record',
      'Refresh Rate',
      0
    );
    const retryRateElement = DomainDetail.domainTableCellValue(
      'SOA Record',
      'Retry Rate',
      0
    );
    const expireTimeElement = DomainDetail.domainTableCellValue(
      'SOA Record',
      'Expire Time',
      0
    );
  ...
  const checkNsRecords = () => {
    [1, 2, 3, 4, 5].forEach(index => {
      ...
      const subDomainElement = DomainDetail.domainTableCellValue(
        'NS Record',
        'Subdomain',
        rowIndex
      );
  ...
  beforeAll(() => {
    ...
    apiCreateDomains(domain);
    DomainDetail.selectDomain(domainName);
  ...
  describe('SOA Record Update', () => {
    ...
    it('SOA record can be updated', () => {
      ...
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('SOA Record'),
        'Edit'
      );
      DomainDetail.editSoaRecordDrawerDisplays();
      browser.trySetValue(
        DomainDetail.inputElementByLabel('Domain').selector,
        domainName
      );
      browser.trySetValue(
        DomainDetail.inputElementByLabel('SOA Email').selector,
        domainEmail
      );
  ...
  describe('NS Record Update', () => {
    ...
    it('A NS Record can be added to a domain', () => {
      ...
      const nameServerCell = DomainDetail.domainTableCellValue(
        'NS Record',
        'Name Server',
        5
      );
      const subDomainCell = DomainDetail.domainTableCellValue(
        'NS Record',
        'Subdomain',
        5
      );
    ...
    it('An added NS Record can be edited', function() {
      ...
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('NS Record'),
        'Edit'
      );
      ...
      expect(subDomainCell.getText()).toEqual(
        `${subDomainUpdate}.${domainName}`
      );
    });
  ...
  describe('MX Record Update', () => {
    it('MX Records are empty by default', () => {
      expect($(DomainDetail.rowSelector('MX Record')).isDisplayed()).toBe(
        false
      );
    });
    ...
    it('A MX Record can be added to a domain', () => {
      ...
      const mailServerCell = DomainDetail.domainTableCellValue(
        'MX Record',
        'Mail Server',
        0
      );
      const preferenceCell = DomainDetail.domainTableCellValue(
        'MX Record',
        'Preference',
        0
      );
    ...
    it('An added MX Record can be edited', function() {
      ...
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('MX Record'),
        'Edit'
      );
      DomainDetail.addMxRecord(
        mailServerUpdate,
        preferenceUpdate,
        subDomainUpdate
      );
  ...
  describe('A/AAAA Record Update', () => {
    xit('A/AAAA Records are empty by default', () => {
      browser.scroll(0, 500);
      expect($(DomainDetail.rowSelector('A/AAAA Record')).isDisplayed()).toBe(
        false
      );
    });
    ...
    it('An A/AAAA Record can be added to a domain', () => {
      ...
      const hostNameCell = DomainDetail.domainTableCellValue(
        'A/AAAA Record',
        'Hostname',
        0
      );
      const ipAddressCell = DomainDetail.domainTableCellValue(
        'A/AAAA Record',
        'IP Address',
        0
      );
      const ttlCell = DomainDetail.domainTableCellValue(
        'A/AAAA Record',
        'TTL',
        0
      );
    ...
    it('An added A/AAAA Record can be edited', function() {
      ...
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('A/AAAA Record'),
        'Edit'
      );
  ...
  describe('CNAME Record Update', () => {
    it('CNAME  Records are empty by default', () => {
      expect($(DomainDetail.rowSelector('CNAME  Record')).isDisplayed()).toBe(
        false
      );
    });
    ...
    it('A CNAME Record can be added to a domain', () => {
      ...
      const aliasToCell = DomainDetail.domainTableCellValue(
        'CNAME Record',
        'Aliases to',
        0
      );
    ...
    it('An added CNAME Record can be edited', function() {
      ...
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('CNAME Record'),
        'Edit'
      );
  ...
  describe('TXT Record Update', () => {
    it('TXT Records are empty by default', () => {
      expect($(DomainDetail.rowSelector('TXT Record')).isDisplayed()).toBe(
        false
      );
    });
    ...
    it('A TXT Record can be added to a domain', () => {
      ...
      const valueCell = DomainDetail.domainTableCellValue(
        'TXT Record',
        'Value',
        0
      );
    ...
    it('An added TXT Record can be edited', function() {
      ...
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('TXT Record'),
        'Edit'
      );
  ...
  describe('SRV Record Update', () => {
    it('SRV Records are empty by default', () => {
      expect($(DomainDetail.rowSelector('SRV Record')).isDisplayed()).toBe(
        false
      );
    });
    ...
    it('A SRV Record can be added to a domain', () => {
      ...
      const ttl = DomainDetail.addSrvRecord(
        serviceName,
        protocol,
        priority,
        weight,
      ...
      const serviceNameCell = DomainDetail.domainTableCellValue(
        'SRV Record',
        'Name',
        0
      );
      const domainCell = DomainDetail.domainTableCellValue(
        'SRV Record',
        'Domain',
        0
      );
      const priorityCell = DomainDetail.domainTableCellValue(
        'SRV Record',
        'Priority',
        0
      );
      const weightCell = DomainDetail.domainTableCellValue(
        'SRV Record',
        'Weight',
        0
      );
      const portCell = DomainDetail.domainTableCellValue(
        'SRV Record',
        'Port',
        0
      );
      const targetCell = DomainDetail.domainTableCellValue(
        'SRV Record',
        'Target',
        0
      );
    ...
    it('An added SRV Record can be edited', function() {
      ...
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('SRV Record'),
        'Edit'
      );
      DomainDetail.addSrvRecord(
        serviceNameUpdate,
        protocolUpdate,
        priorityUpdate,
        weightUpdate,
      ...
      const ttlCell = DomainDetail.domainTableCellValue('SRV Record', 'TTL', 0);
      expect(serviceNameCell.getText()).toEqual(
        `_${serviceNameUpdate}._${protocolUpdate}`
      );
      expect(domainCell.getText()).toEqual(domainName);
  ...
  describe('CAA Record Update', () => {
    it('CAA Records are empty by default', () => {
      expect($(DomainDetail.rowSelector('CAA Record')).isDisplayed()).toBe(
        false
      );
    });
    ...
    it('A CAA Record can be added to a domain', () => {
      ...
      const nameCell = DomainDetail.domainTableCellValue(
        'CAA Record',
        'Name',
        0
      );
    ...
    it('An added CAA Record can be edited', function() {
      ...
      const valueUpdate = '10.0.0.2';
      DomainDetail.selectActionMenuItemV2(
        DomainDetail.rowSelector('CAA Record'),
        'Edit'
      );
  ...
  // TODO this is failing on domain[0] for some reason
  // we are also no longer showing tags on the main domains list
  xit('Tags are displayed in domain list view', () => {
    browser.url(constants.routes.domains);
