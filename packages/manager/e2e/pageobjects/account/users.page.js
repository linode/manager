...
class Users extends Page {
  ...
  baseElementsDisplay() {
    ...
    expect(this.usersHeader.getText())
      .withContext(`${assertLog.incorrectText} for "${this.usersHeader.selector}" selector`)
      .toBe('Users');
    expect(this.usernameColumn.isDisplayed())
      .withContext(`"${this.usernameColumn.selector}" selector ${assertLog.displayed}`)
      .toBe(true);
    expect(this.emailColumn.isDisplayed())
      .withContext(`"${this.emailColumn.selector}" selector ${assertLog.displayed}`)
      .toBe(true);
    expect(this.restrictionColumn.isDisplayed())
      .withContext(`"${this.restrictionColumn.selector}" selector ${assertLog.displayed}`)
      .toBe(true);

    expect(this.addUserButton.isDisplayed())
      .withContext(`"${this.addUserButton.selector}" selector ${assertLog.displayed}`)
      .toBe(true);
  }
