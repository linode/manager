...
class Permissions extends Page {
  get globalPermissionsHeader() {
    return $('[data-qa-permissions-header="Global Permissions"]');
  }
  get billingAccessHeader() {
    return $('[data-qa-permissions-header="billing"]');
  }
  get specificPermissionsHeader() {
    return $('[data-qa-permissions-header="Specific Permissions"]');
  }
  ...
  get globalPermissions() {
    return $$('[data-qa-global-permission]');
  }
  get addLinodesPermission() {
    return $('[data-qa-global-permission="add_linodes"]');
  }
  get addNodeBalancersPermission() {
    return $('[data-qa-global-permission="add_nodebalancers"]');
  }

  // Billing Permissions selection cards
  get billingSection() {
    return $('[data-qa-billing-section]');
  }
  get billingNoPermissions() {
    return $('[data-qa-select-card-heading="None"]');
  }
  get billingReadPermissions() {
    return $('[data-qa-select-card-heading="Read Only"]');
  }
  get billingWriteReadPermissions() {
    return $('[data-qa-select-card-heading="Read-Write"]');
  }

  //Billing Grants
  get billingSection() {
    return $('[data-qa-entity-section]');
  }
  get billingPermissionNone() {
    return $('[data-qa-select-card-heading="None"]');
  }
  get billingPermissionRead() {
    return $('[data-qa-select-card-heading="Read Only"]');
  }
  get billingPermissionWrite() {
    return $('[data-qa-select-card-heading="Read-Write"]');
  }
  ...
  get linodesGrantsHeader() {
    return $('[data-qa-permissions-header="Linodes"]');
  }
  get volumesGrantsHeader() {
    return $('[data-qa-permissions-header="Volumes"]');
  }
  get stackScriptsGrantsHeader() {
    return $('[data-qa-permissions-header="StackScripts"]');
  }
  get nodeBalancersGrantsHeader() {
    return $('[data-qa-permissions-header="NodeBalancers"]');
  }
  get specificGrant() {
    return $('[data-qa-specific-grant]');
  }
  get specifcGrants() {
    return $$('[data-qa-specific-grant]');
  }
  ...
  baseElementsDisplay(restricted) {
    ...
    if (restricted) {
      ...
      expect(this.restrictAccess.isDisplayed())
        .withContext(
          `"${this.restrictAccess.selector}" selector ${assertLog.displayed}`
        )
        .toBe(true);
      ...
      expect(this.unrestrictedMsg.isDisplayed())
        .withContext(
          `"${this.unrestrictedMsg.selector}" selector ${assertLog.displayed}`
        )
        .toBe(true);
      expect(this.restrictAccess.getAttribute('data-qa-restrict-access'))
        .withContext(
  ...
  toggleGlobalPermission(permissionId, permission) {
    $(`[data-qa-global-permission="${permissionId}"]`).waitForDisplayed(
      constants.wait.normal
    );
    if (permission === 'allow') {
      $(`[data-qa-global-permission="${permissionId}"]`).click();
      $(
        `[data-qa-global-permission="${permissionId}"] input:checked`
      ).waitForExist(constants.wait.normal);
    }
    ...
    if (permission === 'restrict') {
      if (
        ...
        $(
          `[data-qa-global-permission="${permissionId}"] input:checked`
        ).waitForExist(constants.wait.normal, true);
      }
    }
  ...
  setSpecificPermission(permType, perm, accessLevel) {
    const permission = $(`[data-qa-permissions-header="${permType}"]`)
      .$('..')
