...
export default function BasicSetup() {
  return (
    <section className="Article">
      ...
      <section>
        <p>
          The Python Library includes an OAuth Client tailored to Linode's OAuth 2 implementation, making it easy to allow users to authenticate against Linode and grant your applications certain rights to their account. All communication between <a href="login.alpha.linode.com">login.alpha.linode.com</a>and your application is handled by the <code>LinodeLoginClient</code>.
        </p>
      </section>
      <section>
        <h2>OAuthScopes</h2>
